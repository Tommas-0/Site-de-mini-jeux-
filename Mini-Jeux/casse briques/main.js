...
//Briques conf
const posXStartBrique = 20; // Réduire la distance entre les briques et les murs
let height = 20;
                ...
                for (let i = 0; i < bricks.length; i++) {
                    if (ball.x + ball.radius > bricks[i].x &&
                        ...
                        const points_number_value = parseInt(points_numbers.innerText);
                          if (points_number_value >= 0 && points_number_value <= 10) {
                              points_numbers.style.color = "red";
                            } else if (points_number_value >= 11 && points_number_value <= 19) {
                                        points_numbers.style.color = "orange";
...
bouton_start.addEventListener("click", () => {
    ...
    helper.innerHTML = "Appuyez sur espace pour lancer la balle, <br> q et d pour bouger,<br> les côtés gauche et droite (orange) inversent la direction de la balle";
